...
<div class="conditions-mobile">
    ...
    <div class="conditions-grid">
        ...
        for ($i = 0; $i < min(7, count($conditions_data)); $i++): 
            ...
            $item = $condition;
            $index = $i;
            include get_template_directory() . '/includes/components/cards/condition-card.php';
        endfor; 
        ?>
        <!-- 20+ more card -->
        <?php 
        ...
        $item = $show_more_data;
        $index = 'more';
        include get_template_directory() . '/includes/components/cards/condition-card-more.php';
        ?>
    </div>
</div>
